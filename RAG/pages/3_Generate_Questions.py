...
def generate_questions_from_stuffed_docs(url_chunks: List[str]):
    llm = ChatOpenAI(api_key=os.getenv("OPENAI_API_KEY"), model="gpt-4o-mini-2024-07-18", temperature=0.2)
...
def main():
    ...
    if process_url:
        ...
        with st.spinner("Generating Interview Questions..."):
            questions_and_answers = generate_questions_from_stuffed_docs(url_chunks)
